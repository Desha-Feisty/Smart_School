            ...
            <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="dropdown dropdown-end relative">
                        <label tabIndex={0} className="btn btn-ghost btn-circle relative hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                        ...
                        <div tabIndex={0} className="dropdown-content absolute right-0 top-full z-[100] mt-4 w-[380px] rounded-3xl bg-white/95 dark:bg-base-300/90 backdrop-blur-2xl border border-slate-200 dark:border-slate-700/50 shadow-2xl overflow-hidden transform transition-all scale-100 origin-top-right">
                                            ...
                                            >
                                                ...
                                                <div className="flex gap-4">
                                                    <div className={`mt-1 p-2 rounded-xl shrink-0 ${
                                                        n.type === 'quiz' ? 'bg-orange-100 text-orange-600' :
                                                        n.type === 'note' ? 'bg-emerald-100 text-emerald-600' :
                                                        'bg-blue-100 text-blue-600'
                                                    }`}>
                                                        {n.type === 'quiz' ? <BookMarked className="w-4 h-4" /> :
                                                         n.type === 'note' ? <ExternalLink className="w-4 h-4" /> :
                            ...
                            {notifications.length > 0 && (
                                <div className="p-3 bg-slate-50/50 dark:bg-slate-800/30 text-center border-t border-slate-100 dark:border-slate-800">
                                    <p className="text-[10px] uppercase tracking-widest font-bold text-slate-400">End of notifications</p>
                                </div>
                            )}
                        </div>
                    </div>
